...
void TargetModel::SetControllerStatus(CONTROLLER_STATUS status) {
...
CONTROLLER_STATUS TargetModel::GetControlStatus() {
	return controllerStatus;
}

State TargetModel::OutTargetPosition() {
	return UpdatePosition(controllerStatus.tickTime);
}
